...
----
最好是使用GPT的模型，因为开发者为在校大学生，没太多时间做更多适配，故暂时最推荐GPT的模型最好（其他厂商AI模型也可以，但质量会受到影响）
----
...
----
It is recommended to use **GPT-series models** for the best experience.  
Since the developer is a college student with limited spare time for extensive compatibility adaptation, GPT models are currently the most optimal choice.  
AI models from other providers are also usable, but the overall experience and response quality may be compromised.
----
